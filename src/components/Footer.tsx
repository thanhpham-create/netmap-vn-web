      ...
      <div className="mx-auto max-w-6xl px-4 py-6 text-xs text-gray-600 sm:py-8 sm:text-sm">
        <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <nav className="flex flex-wrap items-center gap-x-4 gap-y-2">
            ...
            <Link href="/help" className="hover:text-vnred-600 hover:underline">FAQ</Link>
            <Link href="/roadmap" className="hover:text-vnred-600 hover:underline">Roadmap</Link>
            <Link href="/changelog" className="hover:text-vnred-600 hover:underline">Changelog</Link>
